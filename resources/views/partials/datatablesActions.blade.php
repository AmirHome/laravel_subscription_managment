...
{{-- @endcan
@can($deleteGate) --}}
    <form action="{{ route('admin.' . $crudRoutePart . '.destroy', $row->id) }}" method="POST" onsubmit="return confirm('{{ trans('laravel_subscription_managment::global.areYouSure') }}');" style="display: inline-block;">
