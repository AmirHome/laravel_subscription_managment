...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.subscriptionFeature.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.subscription-features.update", [$subscriptionFeature->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
