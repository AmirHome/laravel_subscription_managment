...
{{-- @can('feature_create') --}}
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('ajax.subscription-features.create') }}">
...
@can('subscription_feature_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('ajax.subscription-features.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('ajax.subscription-features.index') }}",
    columns: [
