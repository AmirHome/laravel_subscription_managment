...
<div class="card">
    <div class="card-header">
        {{ trans('laravel_subscription_managment::global.create') }} {{ trans('laravel_subscription_managment::cruds.group.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("ajax.groups.store") }}" enctype="multipart/form-data">
            @csrf
