...
<div class="card">
    <div class="card-header">
        {{ trans('laravel_subscription_managment::global.edit') }} {{ trans('laravel_subscription_managment::cruds.subscriptionGroup.title_singular') }}
    </div>

    <div class="card-body">
    <form method="POST" action="{{ route("ajax.subscription-groups.update", [$subscriptionGroup->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
