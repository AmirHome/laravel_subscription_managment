...
<head>
    ...
    <title>{{ trans('laravel_subscription_managment::panel.site_title') }}</title>
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        ...
        @include('laravel_subscription_managment::partials.menu')
        ...
        <footer class="main-footer">
            ...
            <strong> &copy;</strong> {{ trans('laravel_subscription_managment::global.allRightsReserved') }}
        </footer>
    ...
    <script>
        $(function() {
  let copyButtonTrans = '{{ trans('laravel_subscription_managment::global.datatables.copy') }}'
  let csvButtonTrans = '{{ trans('laravel_subscription_managment::global.datatables.csv') }}'
  let excelButtonTrans = '{{ trans('laravel_subscription_managment::global.datatables.excel') }}'
  let pdfButtonTrans = '{{ trans('laravel_subscription_managment::global.datatables.pdf') }}'
  let printButtonTrans = '{{ trans('laravel_subscription_managment::global.datatables.print') }}'
  let colvisButtonTrans = '{{ trans('laravel_subscription_managment::global.datatables.colvis') }}'
  let selectAllButtonTrans = '{{ trans('laravel_subscription_managment::global.select_all') }}'
  let selectNoneButtonTrans = '{{ trans('laravel_subscription_managment::global.deselect_all') }}'
